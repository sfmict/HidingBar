...
L["SETTINGS_DESCRIPTION"] = "當您點擊在|cff%s線|r: •|cffffd200滑鼠左鍵|r - 拖動條列。•|cffffd200滑鼠右鍵 + Shift|r - 開啟設置。 •|cffffd200滑鼠右鍵 + Alt|r - 鎖定條列位置。"
L["Line"] = "線"
L["Background"] = "背景"
...
L["Buttons"] = "按鈕"
L["Ignore list"] = "忽略列表"
L["BUTTON_PANEL_DESCRIPTION"] = "•|cffffd200滑鼠左鍵|r來啟用/停用按鈕或重新拖動位置。•|cffffd200滑鼠右鍵|r在一個小地圖按鈕以加入忽略清單。"
L["IGNORE_DESCRIPTION"] = "您可以指定名稱的一部分。舉例|cffffd200HidingBar|r將會忽略：|cffffd200HidingBar1|r |cffffd200HidingBar2|r |cffffd200HidingBar3|r ..."
